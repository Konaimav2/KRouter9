...
function resolveStandaloneBuild(appDir, buildDistDir) {
  ...
  // NEXT_TRACING_ROOT_MODE=workspace, e.g. standalone/krouter9/server.js.
...
function buildCliPackage() {
  console.log("📦 Building KRouter9 CLI package with Next.js...\n");
  ...
  // Strip better-sqlite3 (native) — it lives in ~/.krouter9/runtime to avoid
  ...
  if (fs.existsSync(betterDir)) {
    ...
    console.log("✅ Stripped better-sqlite3 (lives in ~/.krouter9/runtime)");
  }
  console.log("");
