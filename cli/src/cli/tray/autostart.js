...
const APP_NAME = "krouter9";
const APP_LABEL = "com.krouter9.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when krouter9 is currently
 ...
 * SIGTERM to the running process. When the running krouter9 cli.js was itself
...
<dict>
    ...
    <string>/tmp/krouter9.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/krouter9.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `krouter9.cmd` lookup that depended on the npm prefix path.
