/**
 * `krouter9 xai video` — generate a Grok Imagine video through the local
 * krouter9 gateway and save the result as an MP4 file.
 *
...
const HELP = `
Usage: krouter9 xai video --prompt "..." [options]

Generate a Grok Imagine video via your local krouter9 gateway
...
Options:
  ...
  --api-key <key>         krouter9 API key (or env NINE_ROUTER_API_KEY)
...
async function run(argv) {
  ...
  try {
    ...
    const connectionId = create.headers["x-krouter9-connection-id"] || null;
