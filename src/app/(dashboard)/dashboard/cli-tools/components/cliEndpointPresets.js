...
const endpoints = createStore({
  storageKey: "krouter9.cliToolEndpointPresets",
  changeEvent: "krouter9:endpoint-presets-changed",
  itemField: "baseUrl",
...
const apiKeys = createStore({
  storageKey: "krouter9.cliToolApiKeyPresets",
  changeEvent: "krouter9:api-key-presets-changed",
  itemField: "key",
});
