...
// Build TOML config for KRouter9 (openai provider mode)
const buildKRouter9Config = (baseUrl, apiKey, model) => {
...
// Detect KRouter9 by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildKRouter9Config(baseUrl, apiKey || "sk_krouter9", model);
