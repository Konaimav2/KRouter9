...
export function autoDetectFilter(text) {
  ...
  // zenrouter extras: structured payloads before generic fallbacks.
  ...
  // Declarative TOML filters (rtk-ai upstream src/filters/*.toml format):
  // match_command tested against the output head — closest post-hoc signal
  // to upstream's wrapped-command match.
